...
public class neighborCGen extends DualPointGen{
	...
	public String[] nextColors(){ 
		...
		if(currentBaseColor1.equals(currentBaseColor2))return null;
		
		float stepsR = (getValuePerRGB(1,currentBaseColor1)-getValuePerRGB(1,currentBaseColor2));
		float stepsG = (getValuePerRGB(2,currentBaseColor1)-getValuePerRGB(2,currentBaseColor2));
		float stepsB = (getValuePerRGB(3,currentBaseColor1)-getValuePerRGB(3,currentBaseColor2));
